...
export interface RxjsAngularXRuleDocs<Options extends readonly unknown[], Desc extends string> {
  description: Desc;
...
export const ruleCreator = ESLintUtils.RuleCreator<RxjsAngularXRuleDocs<unknown[], string>>(
  (name) =>
